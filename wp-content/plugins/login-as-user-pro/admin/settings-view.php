...
<div class="wrap">
    ...
    <div class="lau-settings">
        <div class="lau-about">
            <h2>
                <?php echo esc_html__( 'About Login as User', 'login-as-user-pro' ); ?> (PRO version)
            </h2>
            ...
            <hr> 
                ...
                <div class="lac-buy-pro-btn-container">
                    You already have the <a href="https://www.web357.com/product/login-as-user-wordpress-plugin?utm_source=SettingsPage&utm_medium=BuyProLink&utm_content=loginasuserwp&utm_campaign=upgrade-pro" target="_blank"><strong>PRO</strong></a> version installed. <br> Thank you very much!
                </div>
            ...
            <hr> 
                <h4><?php echo esc_html__( 'Need support?', 'login-as-user-pro'); ?></h4>
                <?php
                echo sprintf(
                    __( '<p>If you are having problems with this plugin, please <a href="%1$s">contact us</a> and we will reply as soon as possible.</p>', 'login-as-user-pro' ),
            ...
            <hr> 
                <span><?php echo __('Developed by', 'login-as-user-pro'); ?></span>
        ...
        <div class="lau-form">
            <h2>
                <?php echo esc_html__( 'How it works?', 'login-as-user-pro' ); ?>
            </h2>
            <?php echo wp_kses( __( '<p style="color:red">You have to navigate to the <a href="users.php"><strong>Users page</strong></a> and then you will see a button with the name "<strong>Login as: `username`</strong>", at the right side of each username. If you click on this button you will login at the front-end of the website as this User.</p>', 'login-as-user-pro' ), array( 'strong' => array(), 'br' => array(), 'p' => array(), 'a' => array('href'=>array()) ) ); ?>

            <h2 style="margin-top: 40px;">
                <?php echo esc_html__( 'Settings', 'login-as-user-pro' ); ?>
            </h2>
            <form action="options.php" method="post">
                <?php settings_fields( 'login-as-user-pro' ); ?>
                <?php do_settings_sections( 'login-as-user-pro' ); ?>
                <?php submit_button( esc_html__( 'Save Settings', 'login-as-user-pro' ) ); ?>
            </form>
        </div>
    </div>
</div>