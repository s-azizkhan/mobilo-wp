...
?>
<div class="max-w-xs transition duration-100 ease-in-out transform rounded-md sc-coupon ticket-coupon-design hover:-translate-y-1 hover:shadow <?php echo esc_attr( $classes ); ?>"
	style="
