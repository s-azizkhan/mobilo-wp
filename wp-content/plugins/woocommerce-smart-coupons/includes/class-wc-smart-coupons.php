...
if ( ! class_exists( 'WC_Smart_Coupons' ) ) {
	...
	class WC_Smart_Coupons {
		...
		private function __construct() {
			...
			add_filter( 'woocommerce_coupon_code', array( $this, 'uppercase_coupon_code' ), 10, 1 );
...
.coupon-container.custom-design .coupon-content {
    ...
    color: #30050b;
		...
		/**
		 * Converts the given coupon code to uppercase.
		 *
		 * This function takes a coupon code as input and returns the code in uppercase letters.
		 * Useful for standardizing coupon codes before processing or storing.
		 *
		 * @param string $coupon_code The coupon code to be converted to uppercase.
		 * @return string The uppercase version of the coupon code.
		 */
		public function uppercase_coupon_code( $coupon_code ) {
			return wc_strtoupper( $coupon_code );
		}
