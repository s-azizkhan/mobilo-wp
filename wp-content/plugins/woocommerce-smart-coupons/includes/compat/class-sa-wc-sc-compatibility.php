...
if ( ! class_exists( 'SA_WC_SC_Compatibility' ) ) {
	...
	class SA_WC_SC_Compatibility {
		 ...
		 * @return boolean
		 */
		public static function is_wc_gte_90() {
			return self::is_wc_greater_than( '8.9.3' );
		}
		...
		public static function is_wc_gte_87() {
			return self::is_wc_greater_than( '8.6.2' );
		}
		...
		public static function is_wc_gte_44() {
			return self::is_wc_greater_than( '4.3.6' );
		}
		...
		public static function is_wc_gte_43() {
			return self::is_wc_greater_than( '4.2.5' );
		}
		...
		public static function is_wc_gte_42() {
			return self::is_wc_greater_than( '4.1.4' );
		}
		...
		public static function is_wc_gte_41() {
			return self::is_wc_greater_than( '4.0.4' );
		}
		...
		public static function is_wc_gte_40() {
			return self::is_wc_greater_than( '3.9.5' );
		}
