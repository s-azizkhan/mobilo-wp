...
define("COOKIE_DOMAIN", env("COOKIE_DOMAIN", ".mobilocard.com"));
...
define("WP_HOME", env("WP_HOME", "https://buy.mobilocard.com"));
define("WP_SITEURL", env("WP_SITEURL", "https://buy.mobilocard.com"));
